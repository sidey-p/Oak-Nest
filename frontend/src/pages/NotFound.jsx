...
const NotFound = () => (
  <div className="mx-auto max-w-xl px-4 py-24 text-center">
    ...
    <Link to="/" className="btn-shine mt-8 inline-block rounded-full bg-brand-900 px-8 py-3 text-sm font-bold text-white shadow-sm transition-all hover:bg-brand-800 hover:shadow-md">
      Back to Home
    </Link>
  </div>
);
